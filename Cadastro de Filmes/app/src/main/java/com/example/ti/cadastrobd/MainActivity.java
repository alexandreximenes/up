 ...
 * Crie uma classe  FilmeAdapter e uma classe FilmeHolder para poder utilizar a recycler view cadastrada.
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<Filme> filmes = dao.get();

        if(filmes == null) Toast.makeText(MainActivity.this, "lista vazia", Toast.LENGTH_LONG).show();

        FilmeAdapter adapter = new FilmeAdapter(filmes, MainActivity.this);
